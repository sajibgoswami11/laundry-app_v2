...
const menuItems = [
    { icon: Squares2X2Icon, label: "Overview", href: "/dashboard/customer" },
    { icon: BuildingStorefrontIcon, label: "Find Shops", href: "/dashboard/customer/shops" },
    { icon: ShoppingBagIcon, label: "My Orders", href: "/dashboard/customer/orders" },
];
        ...
        <>
            ...
            `}>
                <div className="flex items-center justify-between p-6 border-b border-slate-200 md:hidden">
                    <span className="text-lg font-black text-indigo-600">Customer Menu</span>

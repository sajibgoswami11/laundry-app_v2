...
const menuItems = [
    { icon: Squares2X2Icon, label: "Overview", href: "/dashboard/shop" },
    { icon: ShoppingBagIcon, label: "Orders", href: "/dashboard/shop/orders" },
    { icon: QueueListIcon, label: "Services", href: "/dashboard/shop/services" },
];
        ...
        <>
            ...
            `}>
                <div className="flex items-center justify-between p-6 border-b border-slate-200 md:hidden">
                    <span className="text-lg font-black text-indigo-600">Shop Menu</span>
